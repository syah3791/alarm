...
class VClock extends StatefulWidget {
  final double? size;

  const VClock({Key? key, this.size}) : super(key: key);

  @override
  _VClockState createState() => _VClockState();
}

class _VClockState extends State<VClock> {
  Timer? timer;
...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var fillBrush = Paint()..color = Colors.grey;
